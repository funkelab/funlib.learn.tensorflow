# -*- coding: utf-8 -*-
# credits: https://github.com/alexandrosstergiou/keras-DepthwiseConv3D
...
class DepthwiseConv3D(Conv3D):
    ...
    def __init__(self,
        ...
        self._padding = self.padding.upper()
        if self.data_format == "channels_last":
            self._strides = (1,) + self.strides + (1,)
        else:
            self._strides = (1,) + (1,) + self.strides
    ...
    def call(self, inputs, training=None):
        # inputs = _preprocess_conv3d_input(inputs, selfd.ata_format)
...
def depthwise_conv_3d(
        ...
        bias_constraint=None,
        **kwargs):
  """Functional interface for the depthwise conv 3d layer.
  """
  layer = DepthwiseConv3D(kernel_size,
                          strides=strides,
                          padding=padding,
